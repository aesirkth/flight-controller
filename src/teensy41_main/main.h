...
#include "hardware_definition_teensy41.h" // pin definitions
#include "Gps.h" // GPS
...
RandomBuffer telemetry_queue;
RandomBuffer flash_queue;
RandomBuffer lora_queue ;
...
extern FlexCAN_T4<CAN2, RX_SIZE_128, TX_SIZE_128> can;  // 1Mbs, CAN0, pins 29&30 for TX&RX
