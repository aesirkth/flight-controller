...
class ActiveLowChipSelect1Callback : public AbstractChipSelect
{
  public:
    /** Equivalent to AbstractChipSelect, but for SPI1.
    **/
    ActiveLowChipSelect1Callback(const unsigned int& pin, const SPISettings& settings, void (*callback)())
      : pin_(pin),
      settings_(settings),
      callback_(callback)
    {
...
class ActiveLowChipSelectCallback : public AbstractChipSelect
{
  public:
    /** Equivalent to AbstractChipSelect, but for SPI1.
    **/
    ActiveLowChipSelectCallback(SPIClass* spi, const unsigned int& pin, const SPISettings& settings, void (*callback)())
      : pin_(pin),
      settings_(settings),
      callback_(callback),
      spi_(spi)
